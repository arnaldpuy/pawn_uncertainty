...
```{r sample_matrices, cache=TRUE, dependson="settings"}
...
```{r output, cache=TRUE, dependson="sample_matrices"}
...
```{r model_uncertainty, cache=TRUE, dependson="output"}
...
```{r sobol_indices, cache=TRUE, dependson="output"}
...
```{r sobol_indices_dummy, cache=TRUE, dependson="sobol_indices"}
...
```{r sobol_convergence_dt, cache=TRUE, dependson="sobol_indices"}
...
```{r pawn_indices, cache=TRUE, dependson=c("sample_matrices", "output")}
...
```{r pawn_dummy, cache=TRUE, dependson=c("sample_matrices", "output", "pawn_indices")}
...
```{r pawn_convergence_dt, cache=TRUE, dependson="pawn_indices"}
...
```{r export_sobol_pawn_convergence, cache=TRUE, dependson=c("pawn_convergence_dt", "sobol_convergence_dt")}
...
```{r plot_convergence, cache=TRUE, dependson=c("sobol_convergence_dt", "pawn_convergence_dt"), fig.height=4, fig.width=6.3, dev="tikz"}
...
```{r plot_convergence2_samples, cache=TRUE, dependson=c("sobol_convergence_dt", "pawn_convergence_dt"), fig.height=4, fig.width=6.3, dev="tikz"}
...
```{r plot_full_convergence, cache=TRUE, dependson=c("sobol_convergence.dt", "pawn_convergence_dt"), dev="tikz"}
...
```{r plot_convergence2, cache=TRUE, dependson="plot_full_convergence", dev="tikz", fig.height=2, fig.width=6.5}
...
```{r pawn_matrix, cache=TRUE, dependson="pawn_settings"}
...
```{r run_pawn_model, cache=TRUE, dependson=c("pawn_matrices", "pawn_model", "pawn_settings")}
...
```{r extract_pawn_data, cache=TRUE, dependson="run_pawn_model"}
...
```{r uncertainty_dt, cache=TRUE, dependson="extract_pawn_data"}
...
```{r pawn_overlap, cache=TRUE, dependson="uncertainty_dt"}
...
```{r plot_pawn_uncertainty, cache=TRUE, dependson="uncertainty_dt", dev="tikz"}
...
```{r export_pawn, cache=TRUE, dependson="uncertainty_dt"}
...
```{r pawn_sensitivity_dt, cache=TRUE, dependson="extract_pawn_data"}
...
```{r pawn_sensitivity, cache=TRUE, dependson="pawn_sensitivity_dt"}
...
```{r pawn_ci, cache=TRUE, dependson="pawn_sensitivity"}
...
```{r plot_pawn_sensitivity, cache=TRUE, dependson="pawn_ci", dev="tikz", fig.height=2.7}
...
```{r sobol_matrix, cache=TRUE, dependson=c("pawn_settings", "sobol_settings")}
...
```{r run_sobol_model, cache=TRUE, dependson=c("pawn_matrices", "sobol_matrix", "sobol_settings", "sobol_model")}
...
```{r extract_sobol_data, cache=TRUE, dependson="run_sobol_model"}
...
```{r sobol_uncertainty_dt, cache=TRUE, dependson="extract_sobol_data"}
...
```{r plot_sobol_uncertainties, cache=TRUE, dependson="sobol_uncertainty_dt", dev="tikz"}
...
```{r sobol_overlap, cache=TRUE, dependson="sobol_uncertainty_dt"}
...
```{r new_uncertainty_plot, cache=TRUE, dependson = c("sobol_uncertainty_dt", "pawn_uncertainty_dt"), fig.height=8.3}
...
```{r sobol_sensitivity_dt, cache=TRUE, dependson="extract_sobol_data"}
...
```{r sobol_sensitivity, cache=TRUE, dependson="sobol_sensitivity_dt"}
...
```{r sobol_ci, cache=TRUE, dependson="sobol_sensitivity"}
...
```{r plot_sobol, cache=TRUE, dependson="sobol_ci", dev="tikz", fig.height=2, fig.width=2.5}
...
```{r global_uncertainty, cache=TRUE, fig.height=7, dependson=c("uncertainty_dt", "sobol_uncertainty_dt"), dev="tikz"}
...
```{r global_sensitivities, dev="tikz", cache=TRUE, fig.height=2.5, dependson=c("pawn_ci", "sobol_ci")}
...
```{r global_sensitivities_new, cache=TRUE, fig.height=2.5, dependson=c("pawn_ci", "sobol_ci")}
...
```{r plot_aggregated_Si, cache=TRUE, dev="tikz", fig.height=3, fig.width=3.1}
...
```{r plot_single_functions, cache=TRUE, dependson="pawn_ci", dev="tikz", fig.height=8, fig.width=7}
...
```{r plot_morris, cache=TRUE, dependson="pawn_ci", dev="tikz", fig.height=10, fig.width=5}
...
```{r merge_second_third, cache=TRUE, dependson="pawn_ci", dev="tikz", fig.height=2.7}
...
```{r merge_second_third_new, cache=TRUE, dependson="pawn_ci", fig.height=2.4}
...
```{r sum_Si_weighted, cache=TRUE, dependson="pawn_ci", dev="tikz", fig.height=2.5}
...
```{r plot_sobol_functions, cache=TRUE, dependson="sobol_ci", dev="tikz", fig.height=8, fig.width=4.5}
...
```{r plot_morris_sobol, cache=TRUE, dependson="sobol_ci", dev="tikz", fig.height=10, fig.width=3}
...
```{r assesment_outliers, cache=TRUE, dependson = c("sobol_uncertainty_dt", "pawn_uncertainty_dt"), dev="tikz"}
...
```{r assesment_outliers2, cache=TRUE, dependson = c("sobol_uncertainty_dt", "pawn_uncertainty_dt"), fig.height=5.5, fig.width=6}
